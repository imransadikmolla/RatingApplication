package com.imran.project.config.controllers;
...
import com.imran.project.config.impl.ProductServiceImpl;
import com.imran.project.config.impl.ReviewServiceImpl;
import com.imran.project.config.impl.UserServiceImpl;
...
public class MainController {
	...
	public User register(@RequestBody User user) throws Exception {
		try {
			...
			Role role = new Role();
			if (user.getEmail().equalsIgnoreCase("imran@gmail.com")) {
				role.setRoleId(44L);
